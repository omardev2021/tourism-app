...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    // });
    Provider.of<Trips>(context, listen: false).fetchAndSetTrips().then((_) {
      setState(() {
        _isLoading = false;
      });
    });
  ...
  _buildListView() {
    final CatsData = Provider.of<Trips>(context);
        ...
        return GestureDetector(
          onTap: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => DetailScreen(trip)));
          },
          child: Container(
            height: 280.0,
            child: Stack(
              children: <Widget>[
                _buildImageListView(trip),
                _buildBoxInfo(trip)
              ],
            ),
          ),
