...
export default {
  ...
  data() {
    return {
      items: [
        { title: "Trips", icon: "mdi mdi-briefcase", link: "/dashboard" },

        { title: "Bookings", icon: "mdi mdi-bookmark-check", link: "/tables" },
        { title: "Hotels", icon: "mdi mdi-city", link: "/notifications" },
        {
          title: "Reports",
